...
main
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上传到模板镜像的<code>/root/</code> 目录下</p><p>赋予权限：<code>chmod +x /root/first.sh</code></p><h2 id="_8、禁用-grub-规则" tabindex="-1"><a class="header-anchor" href="#_8、禁用-grub-规则" aria-hidden="true">#</a> 8、禁用 grub 规则</h2><h3 id="在-grub-文件里面的-grub-cmdline-linux-变量添加-net-ifnames-0-biosdevname-0" tabindex="-1"><a class="header-anchor" href="#在-grub-文件里面的-grub-cmdline-linux-变量添加-net-ifnames-0-biosdevname-0" aria-hidden="true">#</a> 在 grub 文件里面的 GRUB_CMDLINE_LINUX 变量添加 net.ifnames=0 biosdevname=0</h3><p><strong>原来配置的网卡ip会生效：/etc/sysconfig/network-scripts/ifcfg-ens33</strong>，所以我不需要这里</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># cat /etc/default/grub</span>
<span class="token punctuation">..</span>.
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="二、vagrant" tabindex="-1"><a class="header-anchor" href="#二、vagrant" aria-hidden="true">#</a> 二、Vagrant</h2><h3 id="_1、centos7-9-基本配置" tabindex="-1"><a class="header-anchor" href="#_1、centos7-9-基本配置" aria-hidden="true">#</a> 1、centos7.9 基本配置</h3><h3 id="_2、vagrantfile-文件" tabindex="-1"><a class="header-anchor" href="#_2、vagrantfile-文件" aria-hidden="true">#</a> 2、Vagrantfile 文件</h3><h4 id="vagrant-virtualbox" tabindex="-1"><a class="header-anchor" href="#vagrant-virtualbox" aria-hidden="true">#</a> Vagrant + VirtualBox</h4>`,54),Bs={href:"https://download.virtualbox.org/virtualbox/6.1.34/VirtualBox-6.1.34-150636-Win.exe",target:"_blank",rel:"noopener noreferrer"},zs={href:"https://releases.hashicorp.com/vagrant/2.2.19/",target:"_blank",rel:"noopener noreferrer"},Hs={href:"https://app.vagrantup.com/boxes/search?utf8=%E2%9C%93&sort=downloads&provider=&q=centos",target:"_blank",rel:"noopener noreferrer"},Ws=t(`<p><strong>Vagrant 环境变量配置</strong></p><p>新建用户变量：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>VAGRANT_HOME D:\\rj-win\\Vagrant\\.vagrant.d
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>完成配置后，下面安装虚拟机</p><blockquote><p>cd F:\\vm\\masterVagrantfile、cd F:\\vm\\nodeVagrantfile</p><blockquote><p>vagrant up</p></blockquote><p>默认用户：vagrant 密码：vagrant</p><p>root用户：root：密码：vagrant</p></blockquote><h4 id="vagrant-vmware-desktop" tabindex="-1"><a class="header-anchor" href="#vagrant-vmware-desktop" aria-hidden="true">#</a> Vagrant + VMware-desktop</h4>`,5),js=s("strong",null,"1.下载",-1),Ys={href:"https://releases.hashicorp.com/vagrant/2.2.19/vagrant_2.2.19_x86_64.msi",target:"_blank",rel:"noopener noreferrer"},Zs={href:"https://www.vagrantup.com/vmware/downloads",target:"_blank",rel:"noopener noreferrer"},Js=t(`<p><strong>2.下载 vmware-desktop插件</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>vagrant plugin list
...
<span class="token keyword">fi</span>
<span class="token builtin class-name">exit</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>安装完成后执行<code>kill.bat</code>结束VMware虚拟机的【vmware-vmx.exe】</p><figure><img src="`+r+`" alt="image-20220508160013429" tabindex="0" loading="lazy"><figcaption>image-20220508160013429</figcaption></figure><p>4、kill.bat</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>@echo off
